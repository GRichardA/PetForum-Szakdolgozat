        ...
        <form action="{{ route('events.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                <label class="flex items-center gap-3 rounded-md border border-gray-300 p-3">
                    <input type="checkbox" name="vaccination_required" value="1" {{ old('vaccination_required') ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <input type="number" min="1" name="capacity" id="capacity" value="{{ old('capacity') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2.5">
                </div>
            </div>
